...
def get_memory_service():
    ...
    agent_engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID") or "4781268094825791488"
    from google.adk.memory.vertex_ai_memory_bank_service import VertexAiMemoryBankService

    return VertexAiMemoryBankService(
        project=os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-02-5e57235b3d5f"),
